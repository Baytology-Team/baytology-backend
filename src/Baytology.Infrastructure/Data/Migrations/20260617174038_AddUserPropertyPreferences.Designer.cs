...
namespace Baytology.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260617174038_AddUserPropertyPreferences")]
    partial class AddUserPropertyPreferences
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Baytology.Domain.Entities.AvailabilityRule", b =>
                {
                    ...
                    b.HasIndex("PropertyId", "AgentUserId");
            ...
            modelBuilder.Entity("Baytology.Domain.Entities.Property", b =>
                {
                    ...
                    b.ToTable("Properties", null, t =>
                        {
                            t.HasCheckConstraint("CK_Properties_BusinessRules", "[Price] > 0 AND [Price] >= 1000 AND [Price] <= 999999999 AND [Area] > 0 AND [Area] >= 10 AND [Area] <= 100000 AND [Bedrooms] >= 0 AND [Bedrooms] <= 100 AND [Bathrooms] >= 0 AND [Bathrooms] <= 100 AND ([Floor] IS NULL OR ([Floor] >= 0 AND [Floor] <= 999)) AND ([TotalFloors] IS NULL OR ([TotalFloors] > 0 AND [TotalFloors] <= 999)) AND ([Floor] IS NULL OR [TotalFloors] IS NULL OR [Floor] <= [TotalFloors]) AND ([Latitude] IS NULL OR ([Latitude] >= -90 AND [Latitude] <= 90)) AND ([Longitude] IS NULL OR ([Longitude] >= -180 AND [Longitude] <= 180))");
                        });
                });
            ...
            modelBuilder.Entity("Baytology.Domain.Entities.UserPropertyPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("UserPropertyPreferences", (string)null);
                });
