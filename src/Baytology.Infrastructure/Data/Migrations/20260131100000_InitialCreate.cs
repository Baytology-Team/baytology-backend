        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AgentDetails", x => x.Id)
                        .Annotation("SqlServer:Clustered", false);
                    table.CheckConstraint("CK_AgentDetails_CommissionRate_Range", "[CommissionRate] > 0 AND [CommissionRate] < 1");
                    table.CheckConstraint("CK_AgentDetails_Rating_Range", "[Rating] >= 0 AND [Rating] <= 5");
                    table.CheckConstraint("CK_AgentDetails_ReviewCount_NonNegative", "[ReviewCount] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Notifications", x => x.Id)
                        .Annotation("SqlServer:Clustered", false);
                    table.CheckConstraint("CK_Notifications_ReadState", "([IsRead] = 0 AND [ReadAt] IS NULL) OR ([IsRead] = 1 AND [ReadAt] IS NOT NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceListingUrl = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Properties", x => x.Id)
                        .Annotation("SqlServer:Clustered", false);
                    table.CheckConstraint("CK_Properties_BusinessRules", "[Price] > 0 AND [Area] > 0 AND [Bedrooms] >= 0 AND [Bathrooms] >= 0 AND ([Floor] IS NULL OR [Floor] >= 0) AND ([TotalFloors] IS NULL OR [TotalFloors] > 0) AND ([Floor] IS NULL OR [TotalFloors] IS NULL OR [Floor] <= [TotalFloors]) AND ([Latitude] IS NULL OR ([Latitude] >= -90 AND [Latitude] <= 90)) AND ([Longitude] IS NULL OR ([Longitude] >= -180 AND [Longitude] <= 180))");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecommendationRequests", x => x.Id)
                        .Annotation("SqlServer:Clustered", false);
                    table.CheckConstraint("CK_RecommendationRequests_BusinessRules", "LEN(LTRIM(RTRIM([RequestedByUserId]))) > 0 AND LEN(LTRIM(RTRIM([SourceEntityType]))) > 0 AND [TopN] >= 1 AND [TopN] <= 50 AND (([Status] = 'Pending' AND [ResolvedAt] IS NULL) OR ([Status] <> 'Pending' AND [ResolvedAt] IS NOT NULL))");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SearchRequests", x => x.Id)
                        .Annotation("SqlServer:Clustered", false);
                    table.CheckConstraint("CK_SearchRequests_State", "LEN(LTRIM(RTRIM([UserId]))) > 0 AND [ResultCount] >= 0 AND (([Status] = 'Pending' AND [ResolvedAt] IS NULL) OR ([Status] <> 'Pending' AND [ResolvedAt] IS NOT NULL))");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AgentReviews", x => x.Id)
                        .Annotation("SqlServer:Clustered", false);
                    table.CheckConstraint("CK_AgentReviews_DistinctUsers", "[AgentUserId] <> [ReviewerUserId]");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Conversations", x => x.Id)
                        .Annotation("SqlServer:Clustered", false);
                    table.CheckConstraint("CK_Conversations_DistinctParticipants", "[BuyerUserId] <> [AgentUserId]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Payments", x => x.Id)
                        .Annotation("SqlServer:Clustered", false);
                    table.CheckConstraint("CK_Payments_Amounts_Valid", "[Amount] > 0 AND [Commission] >= 0 AND [Commission] <= [Amount] AND [NetAmount] = [Amount] - [Commission]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertyImages", x => x.Id)
                        .Annotation("SqlServer:Clustered", false);
                    table.CheckConstraint("CK_PropertyImages_BusinessRules", "LEN(LTRIM(RTRIM([Url]))) > 0 AND [SortOrder] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecommendationResults", x => x.Id)
                        .Annotation("SqlServer:Clustered", false);
                    table.CheckConstraint("CK_RecommendationResults_BusinessRules", "[Rank] > 0 AND [SimilarityScore] >= 0 AND ([SnapshotPrice] IS NULL OR [SnapshotPrice] >= 0) AND ([RecommendedPropertyId] IS NOT NULL OR [ExternalReference] IS NOT NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SearchResults", x => x.Id)
                        .Annotation("SqlServer:Clustered", false);
                    table.CheckConstraint("CK_SearchResults_BusinessRules", "[Rank] > 0 AND [RelevanceScore] >= 0 AND ([SnapshotPrice] IS NULL OR [SnapshotPrice] >= 0)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Messages", x => x.Id)
                        .Annotation("SqlServer:Clustered", false);
                    table.CheckConstraint("CK_Messages_ContentOrAttachment", "LEN([Content]) > 0 OR [AttachmentUrl] IS NOT NULL");
                    table.CheckConstraint("CK_Messages_ReadState", "([IsRead] = 0 AND [ReadAt] IS NULL) OR ([IsRead] = 1 AND [ReadAt] IS NOT NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bookings", x => x.Id)
                        .Annotation("SqlServer:Clustered", false);
                    table.CheckConstraint("CK_Bookings_DateRange", "[StartDate] < [EndDate]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaymentTransactions", x => x.Id)
                        .Annotation("SqlServer:Clustered", false);
                    table.CheckConstraint("CK_PaymentTransactions_RequiredState", "LEN(LTRIM(RTRIM([GatewayName]))) > 0 AND LEN(LTRIM(RTRIM([TransactionStatus]))) > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_RefundRequests_ReviewState", "([Status] = 'Pending' AND [ReviewedBy] IS NULL AND [ReviewedOnUtc] IS NULL) OR ([Status] IN ('Approved','Rejected','Processed') AND [ReviewedBy] IS NOT NULL AND [ReviewedOnUtc] IS NOT NULL)");
                    table.CheckConstraint("CK_RefundRequests_Status_Valid", "[Status] IN ('Pending','Approved','Rejected','Processed')");
                    table.ForeignKey(
