...

{
...

    {
        ...
        RuleFor(x => x.ImageUrls)
            ...
            .Must(urls => urls == null || urls.All(url => IsValidUrl(url)))

            .WithMessage("Image URLs must be valid URLs.")
        ...
        RuleFor(x => x.ImageUrls)
            ...
            .Must(urls => urls == null || urls.All(url => IsValidImageUrl(url)))

            .WithMessage("Image URLs must have valid image extensions (.jpg, .jpeg, .png, .webp, .gif).")
