...
public static class ApplicationErrors
{
    ...
    public static class ExternalLogin
    {
        ...
        public static readonly Error EmailMissing =
            Error.Validation("ExternalLogin_Email_Missing", "External account must have an email address associated.");

        public static readonly Error UserInfoFailed =
            Error.Unexpected("ExternalLogin_UserInfo_Failed", "Failed to retrieve external user info.");
