            ...
            _ => Content(
                ...
                <body>
                    <div class="card">
                        ...
                        <a href="https://localhost:4200/bookings" style="display:inline-block;margin-top:16px;padding:12px 24px;background:#0f766e;color:white;border-radius:10px;text-decoration:none;font-weight:600;">← Return to My Bookings</a>
                    </div>
                </body>
                </html>
                """,
